...
namespace DataProcessingBS.Migrations
{
    ...
    [Migration("20250124124153_AddGetMoviesByGenreStoredProcedure")]
    partial class AddGetMoviesByGenreStoredProcedure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataProcessingBS.Contracts.MovieDto", b =>
                {
            ...
            modelBuilder.Entity("DataProcessingBS.Contracts.SubscriptionDto", b =>
                {
            ...
            modelBuilder.Entity("DataProcessingBS.Entities.Movie", b =>
                {
                    b.HasOne("DataProcessingBS.Entities.Media", "Media")
                        .WithMany()
                        .HasForeignKey("Media_Id1")
